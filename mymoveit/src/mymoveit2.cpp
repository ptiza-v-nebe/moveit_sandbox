...
int main(int argc, char** argv)
{
  ...
  visual_tools.publishText(text_pose, "No Path Constraint", rvt::WHITE, rvt::XLARGE);
  ...
  geometry_msgs::PoseStamped non_constrainted_pose = move_group.getCurrentPose("panda_link7");
  non_constrainted_pose.pose.orientation.w = 1;
  non_constrainted_pose.pose.position.x = -0.1;
  non_constrainted_pose.pose.position.y = 0.4;
  non_constrainted_pose.pose.position.z = 0.9;
  move_group.setPoseTarget(non_constrainted_pose);
  ...
  visual_tools.prompt("press next to plan and move to unconstrainted pose");
